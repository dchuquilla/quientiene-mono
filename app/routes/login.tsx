...
export const loader = async ({
  ...
  if (invalidCredentials) {
    return json<LoaderData>({ error: "Credenciales inválidas" }, {
      status: 401,
    });
  } else {
    return json({});
              ...
              <div className="md:max-w-md w-full px-4 py-4">
                <Form method="post">
                  <div className="mb-12">
                    ...
                    <p className="text-sm mt-4 text-gray-800">No tiene cuenta <a href={"/stores/new"} className="text-blue-600 font-semibold hover:underline ml-1 whitespace-nowrap">Registrarse</a></p>
                  </div>

                  <div>
                    <Label htmlFor="email" className="text-gray-800 text-xs block mb-2">Email</Label>
                    <div className="relative flex items-center">
                      <TextInput id="email" name="email" type="text" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter email" />
                  ...
                  <div className="mt-8">
                    ...
                    <div className="relative flex items-center">
                      <TextInput id="password" name="password" type="password" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Enter password" />
                  ...
                  <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
                    <div className="flex items-center">
                      <Checkbox id="remember-me" name="remember-me" className="h-4 w-4 shrink-0 text-blue-600 focus:ring-blue-500 border-gray-300 rounded" />
